...
const OfferPopup = forwardRef<HTMLDivElement, OfferPopupProps>(
  function OfferPopup({ show = true, delay = 3000 }, ref) {
          ...
          <div className="p-6 sm:p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button variant="gold" size="lg" asChild>
                <Link to={`/booking?deal=${deal.id}`} onClick={handleDismiss} className="flex items-center gap-2">
                  Claim Offer
